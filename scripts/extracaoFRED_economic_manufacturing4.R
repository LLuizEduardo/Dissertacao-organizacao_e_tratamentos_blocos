...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  manufacturing4 <- list('BSCICP03AUM665S','LCEAMN01ILM657S','ISRPPDMMINMEI','ISRPROMANMISMEI','ISRPIEAMP02GPM','PIEAMP02KRM659N','KORPPDMMINMEI','BSCICP03KRM665S','BSSPFT02KRM460S','BSOITE02KRM460S','KORPRMNTO01GPSAM','KORSLMNTO01IXOBSAM')
          substitute(
            manufacturing4
          )->nomeBloco
