...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  trade3 <- list('BELLOCOBXNOSTSAM','BELXTIMVA01CXMLM','DNKLOCOXGNOSTSAM','IRLLOCOTXORSTSAM','XTIMVA01IEM657S','EXP4210','NLDXTIMVA01CXMLM','XTEXVA01NOM657S','EXP4550','IMP4550','EXP4700','ESPXTEXVA01CXMLM','XTIMVA01ESM657S','XTEXVA01CHM657S','CHEXTEXVA01CXMLM')
