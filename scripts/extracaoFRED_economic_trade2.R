...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  trade2 <- list('ARGXTEXVA01GPSAM','IMP3570','XTEITT01BRM156S','EXP3510','BRAXTEXVA01NCMLM','XTEXVA01BRM657S','XTIMVA01BRM657S','IMP3510','BRAXTIMVA01NCMLM','XTEITT01CNM156S','XTEITT01INM156S','EXP5330','XTEXVA01INM657S','IMP5330','XTIMVA01INM657S','MEXXTIMVA01NCMLM','IMPMX','RUSLOCOBXNOSTSAM','XTEXVA01RUM657S','RUSXTEXVA01NCMLM','TURLOCOTXORSTM','TURXTIMVA01CXMLM','TURLOCOMGORCXMLSAM')
              substitute(
              trade2
          )->nomeBloco
