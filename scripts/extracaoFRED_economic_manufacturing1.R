...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  manufacturing1 <- list('PIEAFD01CAM661N','CANPROMANMISMEI','CANSTMNIS01STM','BSPRFT02FRM460S','FRAPROMANMISMEI','DEUPIEAMP02GPM','DEUPRMNCG02IXOBSAM','DEUPRMNVG01IXOBSAM','BSFGLV02DEM460S','DEUODMNTO01IXOBSAM','DEUPIEAFD02GPM','ITASLMNTO02IXOBSAM','ITAPROMANMISMEI','JPNPROMANMISMEI','HOHWMN03JPM661S','BSCICP02GBM460S','LCEAMN02GBM661S','GBRPROMANMISMEI','AMDMUO','CAPUTLGMFNS','CAPUTLGMFDS','AMTMUO','CAPGMFOS','CAPUTLGMFOS')
            substitute(
            manufacturing1
          )->nomeBloco
