...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  commodities <- list('EMVCOMMMKT','MCOILWTICO','MCOILBRENTEU','MJFUELUSGULF','IR','IQAG','CUURX000SAM1','CUURX000SACL1E','WPS022','WPS022206','CUURA000SACE','CUURX000SACL1','CUURA000SACL1','WPS0551','WPS0573','WPS054321','WPS026','WPS055','WPS057103','WPS057302','WPS0132','WPS013102','WPS011102','WPS0571','WPS0542','WPS0142')
                substitute(
  commodities
                )->nomeBloco
...
saveRDS(lista,paste0(rootFolder,folder,'/baseRData/',nomeBloco,'.RData'))
