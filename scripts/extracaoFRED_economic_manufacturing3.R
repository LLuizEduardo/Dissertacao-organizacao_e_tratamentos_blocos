...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  manufacturing3 <- list('AUTPROMANMISMEI','LCEAMM01ATM661N','AUTPRMNCG01IXOBSAM','AUTPRMNCG02IXOBSAM','PIEAMP02BEM657N','BELPPDMMINMEI','BELPRMNCG02IXOBSAM','BELPRMNVG01IXOBSAM','BSSPFT02BEM460S','DNKPRMNCG02IXOBSAM','DNKPRMNIG01IXOBSAM','DNKPRMNVG01IXOBSAM','DNKPROMANMISMEI','DNKPIEAMP02GPM','DNKPIEAMP01GPM','PIEAMP01DKM661N','BSCICP02IEM460S','BSSPFT02IEM460S','IRLPIEAFD02GPM','IRLPROMANMISMEI','PIEAFD01IEM661N','IRLPIEAMP01GPM','BSCICP02NLM460S','BSFGLV02PLM460S','POLPROMANMISMEI','BSPRFT02PLM460S','ESPPROMANMISMEI','BSSPFT02ESM460S','BSPRFT02ESM460S','BSPRTE02ESM460S','ESPPIEAMP02GPM','SWEPROMANMISMEI','BSSPFT02SEM460S','BSCICP03SEM665S','BSPRFT02SEM460S','LCLCMM01SEM661N','SWESLMNTO02IXOBM','BSCICP02CHM460S')
                substitute(
            manufacturing3
          )->nomeBloco
