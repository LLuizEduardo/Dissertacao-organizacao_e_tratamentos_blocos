...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  monetary_policy2 <- list('RBARBIS','ARGCCUSMA02STM','IRSTCB01BRM156N','IRSTCI01BRM156N','TRESEGBRM052N','IRSTPI01INM156N','INTDSRINM193N','IRSTCB01INM156N','IRSTCI01INM156N','TRESEGINM052N','CCUSSP01TRM650N','INTDSRTRM193N')
