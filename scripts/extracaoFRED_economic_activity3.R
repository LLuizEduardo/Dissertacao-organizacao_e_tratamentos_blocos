...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  economic_activity3 <- list('BELLOCOBDNOSTSAM','BVEMTE02BEM460S','BSEMFT02BEM460S','BCEMFT02BEM460S','00XHOUBEM086NEST','CP0500BEM086NEST','CP0410BEM086NEST','CP0430BEM086NEST','CP0432BEM086NEST','SERVHOBEM086NEST','CP0400BEM086NEST','CP1252BEM086NEST','BELLOCOBPNOSTSAM','CP0611BEM086NEST','BELPRCNTO01IXOBM','SERVRPBEM086NEST','BELCPGRSE01IXOBM','CP1120BEM086NEST','BVDEFT02BEM460S','BVDETE02BEM460S','CP0730BEM086NEST','BCEMFT02DKM460S','BSEMFT02DKM460S','CP0430DKM086NEST','DNKPRMITO01IXOBSAM','DNKLOCOBPNOSTSAM','SERVMIDKM086NEST','CP1252IEM086NEST','IRLCP120000GPM','CP0730IEM086NEST','SERVTRIEM086NEST','BVEMTE02NLM460S','BSEMFT02NLM460S','CP0444NLM086NEST','CP0400NLM086NEST','NLDLOCOBPNOSTSAM','CP0621NLM086NEST','BVDEFT02NLM460S','SERVMINLM086NEST','CP0550PLM086NEST','CP0444PLM086NEST','ESPBRODFT02STSAM','BVEMTE02ESM460S','BVEMFT02ESM460S','CP0440ESM086NEST','CP0400ESM086NEST','CP0500ESM086NEST','ESPPERMITMISMEI','CP1252ESM086NEST','ESPPRMITO01IXOBSAM','ESPPROCONMISMEI','ESPPREND401IXOBSAM','CP1120ESM086NEST','SERVCOESM086NEST','CP0621ESM086NEST','BVDETE02ESM460S','ESPCPHP1200GPM','SWEPRINTO01GPSAM','BVDEFT02SEM460S','CHELOCOBDNOSTSAM')
...
for (i in 2:(length(lista))) {
    ...
    d$date<-substr(d$date, start = 1, stop = 7)
      ...
      if (max(d$date) >= '2021-12' & min(d$date) <= '2000-01') {
