...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  economic_activity4 <- list('AUSLOCOBDNOSTSAM','LREMTTTTAUM156S','LFEMTTTTAUM657S','AUSLOCOBPNOSTSAM','ISRPERMITMISMEI','ISRCPGRLH01IXOBM','LFEAICTTKRM647S','LFESEETTKRM647S','LFEASETTKRM647S','KORPISPPR02GPM','KORCP120000GPM','KORCPGRSE01IXOBM','KORB6DBSE01CXCUSAM')
                substitute(
    economic_activity4
                )->nomeBloco
