...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  monetary_policy1 <- list('IRSTCI01CAM156N','CPGRLE01FRM657N','NBDEBIS','CSINFT02DEM460S','CPGRLE01DEM657N','IRSTCI01DEM156N','TRESEGDEM052N','DEULOCOSINOSTSAM','DEULOCOSIORSTM','CCRETT01GBM661N','CCUSSP01GBM650N','IRLTLT01GBM156N','CUSR0000SAD','PCU311212311212','PCU212210212210','DPCCRC1M027SBEA','MICH','EMVMACROINFLATION','PCU212322212322','CUSR0000SETB01','PCU311311','HQMCB100YR','HQMCB10YRP','HQMCB1YR','BAMLC0A2CAAEY','BAMLH0A3HYCEY','BAMLHYH0A3CMTRIV','DTP30A29','CPN3M','EMVMACROINTEREST','M2REAL','T3MFFM','T10Y2YM','T10Y3MM','T6MFFM')
        substitute(
          monetary_policy1
          )->nomeBloco
