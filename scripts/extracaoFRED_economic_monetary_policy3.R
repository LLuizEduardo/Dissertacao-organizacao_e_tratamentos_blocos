...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  monetary_policy3 <- list('RBBEBIS','CCRETT01BEM661N','RNBEBIS','CCUSSP01BEM650N','CPGRLE01BEM657N','IR3TIB01BEM156N','IRSTCI01BEM156N','IRLTCT01BEM156N','IRLTLT01BEM156N','NBIEBIS','CCRETT01IEM661N','CPGRLE01IEM657N','CSINFT02NLM460S','NLDCPHPLA01IXOBM','IRLTLT01NLM156N','RBESBIS','CCUSMA02ESM661N','RNESBIS','CPGRLE01ESM657N','CPGRLE01CHM657N','IRSTCI01CHM156N')
          substitute(
          monetary_policy3
          )->nomeBloco
