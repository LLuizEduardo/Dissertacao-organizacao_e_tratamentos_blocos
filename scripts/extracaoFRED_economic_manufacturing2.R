...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  manufacturing2 <- list('BRAPROMANMISMEI','BSPRFT02BRM460S','BSCICP02BRM460S','BSCURT02BRM160S','INDPRMNTO01IXOBM','INDPRMNCG02IXOBSAM','CCRETT01INM661N','WPIAMP01INM661N','INDWPIAMP01GPM','BSCURT02MXM160S','MEXPROMANMISMEI','BSCICP02RUM460S','RUSPPDMMINMEI','TURPROMANMISMEI')
              substitute(
            manufacturing2
          )->nomeBloco
