...
# set folder ------------------------------------------------------------------
  ...
  lista <- 
  work3 <- list('LMUNRRTTATM156S','LRHUTTFEATM156S','LMUNRLTTBEM647S','LFHUTTTTBEM647S','LMUNRLTTIEM647S','LMUNRRTTNOM156S','LMUNRLTTESM647S','LFHUTTTTESM647S','LMUNRLTTCHM647S')
        substitute(
  work3
          )->nomeBloco
